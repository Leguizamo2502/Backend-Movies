...
namespace Web.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(ILogger<AuthController> logger,IToken token, IOptions<JwtSettings> jwtOptions,
            IOptions<CookieSettings> cookieOptions,
            IAuthCookieFactory cookieFactory, IUserService userService)
        {
            _logger = logger;
            _token = token;
        ...
        public async Task<IActionResult> Registrarse(UserCreateDto objeto)
        {
            try
            {
                var userCreated = await _userService.CreateAsync(objeto);
