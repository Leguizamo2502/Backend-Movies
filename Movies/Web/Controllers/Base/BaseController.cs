...
namespace Web.Controllers.Base
{
    ...
    public abstract class BaseController<TSelect, TCreate, TUpdate, TService> : ControllerBase
        where TService : class
    {
        ...
        [ProducesResponseType(404)]
        [ProducesResponseType(500)]
        public virtual async Task<IActionResult> Put(int id, [FromBody] TUpdate dto)
        {
            try
            {
        ...
        protected abstract Task<bool> UpdateAsync(int id, TUpdate dto);
