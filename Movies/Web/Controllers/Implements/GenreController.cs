...
namespace Web.Controllers.Implements
{
    ...
    public class GenreController : BaseController<GenreSelectDto, GenreCreateDto, GenreUpdateDto, IGenreService>
    {
        public GenreController(IGenreService service, ILogger<GenreController> logger) : base(service, logger)
        {
        }

        protected override Task AddAsync(GenreCreateDto dto)
        {
        ...
        protected override async Task<IEnumerable<GenreSelectDto>> GetAllAsync(GetAllType getAllType)
        {
        ...
        protected override Task<GenreSelectDto?> GetByIdAsync(int id)
        {
        ...
        protected override Task<bool> UpdateAsync(int id, GenreUpdateDto dto)
        {
